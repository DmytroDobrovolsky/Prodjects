...
console.log('evenNumber',Boolean(floorSum % 2 )); //визначення парності суми округлених товарів//
...
//Мінімальна ціна:15.678 , максимальна ціна:123.965 , сума товарів:229.8775 , сума округлених товарів:228 , сума товарів округлена до сотень:300 , чи є сума товарів парним числом:yes , сума решти при оплаті клієнтом 500 грн:270.1225, середнє значення цін округлене до сотих:76.63 , випадкова знижка:9% ,сума до оплати зі знижкою округлена до сотих:209.19 , чистий прибуток:129.31 .//
